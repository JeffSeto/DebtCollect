        ...
        try {
            ...
            stripe.createToken(sCard, new TokenCallback() {
                ...
                public void onError(Exception error) {
                    Toast.makeText(PayBillActivity.this,error.getLocalizedMessage(), Toast.LENGTH_LONG).show();
...
//                    toast.show();
                ...
                public void onSuccess(Token token) {
                    toast = new AlertDialog.Builder(PayBillActivity.this);
                    toast.setMessage("Succesfully sent payment to stripe");
                    toast.show();
                    DBHandler db = new DBHandler(PayBillActivity.this, null, null, 1);
